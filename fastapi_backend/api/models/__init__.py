"""
Models package - Complete models for FastAPI routes
Includes all models needed by existing routes and services
"""
...
class TradeRequest(BaseModel):
    ...
    max_slippage_percent: Optional[Decimal] = Field(None, ge=0, le=100)
    description: Optional[str] = Field(None, max_length=500)
...
try:
    ...
    # Define basic user admin models if the file doesn't exist
    ...
    class CreateUserRequest(BaseModel):
        ...
        full_name: str
        role: UserRole
        initial_balance: Optional[str] = "0.00"
